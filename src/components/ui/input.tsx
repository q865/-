  ...
  return (
    <input
      ...
      className={cn(
        ...
        "h-11 py-2",
        type === "file" &&
          "cursor-pointer file:mr-3 file:rounded-lg file:border-0 file:bg-gold-muted-light/50 file:px-3 file:py-1.5 file:text-sm file:font-medium file:text-gold-muted-dark hover:file:bg-gold-muted-light",
        className,
      )}
      {...props}
    />
